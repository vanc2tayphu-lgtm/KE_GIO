...
Khi giáo viên bấm `Lưu bảng kê`, sheet `Tong hop ke gio` sẽ có mỗi giáo viên một dòng. Bảng có cột `Số tt`, `Họ tên GV`, `Môn`; từ tháng 9 đến tháng 5, mỗi tháng được merge 3 cột: `Tổng`, `Thừa`, `Thiếu`.
